"""05 - Compara Elo vs Dixon-Coles prediciendo Mundiales pasados (out-of-sample).
...
for anio, inicio in MUNDIALES.items():
    ...
    print(f"  {'Dixon-Coles':<14}{ld:>10.4f}{bd:>9.4f}{ad:>9.1%}")
...
print(f"  {'Dixon-Coles':<14}{m[3]:>10.4f}{m[4]:>9.4f}{m[5]:>9.1%}")
ganador = "Dixon-Coles" if m[3] < m[0] else "Elo"
...
for anio, le, be, ae, ld, bd, ad in resumen:
    ...
    filas.append({"mundial": str(anio), "motor": "Dixon-Coles", "log_loss": ld, "brier": bd, "acierto": ad})
filas.append({"mundial": "Promedio", "motor": "Elo", "log_loss": m[0], "brier": m[1], "acierto": m[2]})
filas.append({"mundial": "Promedio", "motor": "Dixon-Coles", "log_loss": m[3], "brier": m[4], "acierto": m[5]})
